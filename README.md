...
Developed by: Zhongheng Wu, Nanjing University

This is a modified version of the original FlashAttention that replaces NVIDIA CUDA kernels with FlagGems' Triton implementation, enabling broader hardware support while maintaining API compatibility.

---

## Original FlashAttention

This implementation is based on the official FlashAttention and FlashAttention-2 from the following papers.
